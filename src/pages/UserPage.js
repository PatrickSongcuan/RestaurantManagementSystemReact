          ...
          <div className="container pb-6">
            <div className="row justify-content-center text-center">
              <div className="col-xl-8 col-lg-9 col-md-10">
                <h1 className="display-4 mb-5">Welcome to <br/> Restaurant Management System</h1>
                <p className="lead">Manage your own restaurant seamlessly.</p>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            ...
            <div class="row justify-content-center">
              <p className="lead">The site is currently undergoing development.
                Target release of the update on this page is on <b> November 2019! </b>
              </p>
            </div>
          </div>
        </section>
